...
VENDOR_SKIP_FILES=(
    # Standard build output with vendor image build enabled    "apex/com.android.hardware.cas.apex"
    ...
    "lib64/android.hardware.cas.native@1.0.so"
    "lib64/android.hardware.cas@1.0.so"
    "lib64/android.hardware.cas@1.1.so"
    "lib64/android.hardware.cas@1.2.so"
    ...
    "overlay/EmergencyInfo__lynx__auto_generated_rro_vendor.apk"
    "overlay/NfcNci__lynx__auto_generated_rro_vendor.apk"
    "overlay/Settings__lynx__auto_generated_rro_vendor.apk"
    "overlay/StorageManager__lynx__auto_generated_rro_vendor.apk"
    "overlay/SystemUI__lynx__auto_generated_rro_vendor.apk"
    "overlay/TeleService__lynx__auto_generated_rro_vendor.apk"
    "overlay/ThemePicker__lynx__auto_generated_rro_vendor.apk"
    "overlay/Traceur__lynx__auto_generated_rro_vendor.apk"
    "overlay/framework-res__lynx__auto_generated_rro_vendor.apk"
    ...
    "overlay/DMService__lynx__auto_generated_rro_vendor.apk"
    ...
    "overlay/WallpaperPickerGoogleRelease__lynx__auto_generated_rro_vendor.apk"
    ...
    "lib/android.hardware.radio.data-V1-ndk.so"
    "lib/android.hardware.radio.deprecated@1.0.so"
    "lib/android.hardware.radio.messaging-V1-ndk.so"
    "lib/android.hardware.radio.modem-V1-ndk.so"
    "lib/android.hardware.radio.network-V1-ndk.so"
    "lib/android.hardware.radio.sim-V1-ndk.so"
    "lib/android.hardware.radio.voice-V1-ndk.so"
